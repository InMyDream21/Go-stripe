...
func (app *application) CreateCustomerAndSubscribeToPlan(w http.ResponseWriter, r *http.Request) {
	...
	v.Check(data.LastName == "", "last_name", "must be atleast 2 characters")
...
func (app *application) CreateAuthToken(w http.ResponseWriter, r *http.Request) {
	...
	// get the user from the database by email; send error if invaid email
...
func (app *application) AllSubscriptions(w http.ResponseWriter, r *http.Request) {
	...
	allSales, lastPage, totalRecords, err := app.DB.GetAllOrdersPaginated(1, payload.PageSize, payload.CurrentPage)
	if err != nil {
		app.badRequest(w, r, err)
		return
	}
